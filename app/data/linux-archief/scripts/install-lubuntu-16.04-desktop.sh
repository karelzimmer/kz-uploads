#############################################################################
# Bestand:  install-lubuntu-16.04-desktop.sh                                #
# Doel:     Installatiebestand voor Lubuntu 16.04 LTS desktop.              #
# Gebruik:  In het terminalvenster met script install (aanbevolen):         #
#           install [~/bin/install-lubuntu-16.04-desktop.sh]                #
#           Direct in het terminalvenster:                                  #
#           bash ~/bin/install-lubuntu-16.04-desktop.sh                     #
...
#           install -s [~/bin/install-lubuntu-16.04-desktop.sh]             #
...
#1 [ 1/12] Installeer meldingen-systeem
##=====================================
sudo apt-get install --yes libnotify-bin

#@multimedia-ondersteuning
#1 [ 2/12] Installeer multimedia-ondersteuning
##============================================
...
#@google-chrome
#1 [ 3/12] Installeer Google Chrome 64-bit - webbrowser
##=====================================================
...
#@keepassx
#1 [ 4/12] Installeer KeePassX - wachtwoordkluis
##==============================================
sudo apt-get install --yes keepassx

#@libreoffice
#1 [ 5/12] Installeer LibreOffice - kantoorpakket
##===============================================
sudo apt-get install --yes libreoffice

#@skype
#1 [ 6/12] Installeer Skype - (beeld)bellen over het internet
##===========================================================
...
#@thunderbird
#1 [ 7/12] Installeer Thunderbird - e-mail/nieuws
##===============================================
## Installeer (agenda voor) Thunderbird.
sudo apt-get install --yes thunderbird xul-ext-lightning

#@vlc
#1 [ 8/12] Installeer VLC - multimediaspeler
##==========================================
sudo apt-get install --yes vlc

#1 [ 9/12] Installeer extra stuurprogramma's
##==========================================
...
#@taalondersteuning
#1 [10/12] Wijzig taalondersteuning
##=================================
sudo apt-get install --yes $(check-language-support)

#1 [11/12] Wijzig foutrapportage
##==============================
...
#1 [12/12] Wijzig opstartwachttijd
##================================
