# ###############################################################################
# Bestand:  setup-lubuntu-18.04-desktop.sh
# Doel:     Instellingsbestand voor Lubuntu 18.04 LTS desktop
# Gebruik:  1. In het terminalvenster met script setup (aanbevolen):
#              setup /usr/local/bin/setup-lubuntu-18.04-desktop.sh
#           2. Direct in het terminalvenster:
#              bash /usr/local/bin/setup-lubuntu-18.04-desktop.sh
...
#              setup -s /usr/local/bin/setup-lubuntu-18.04-desktop.sh
