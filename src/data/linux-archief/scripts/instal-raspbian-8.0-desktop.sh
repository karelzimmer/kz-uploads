...
:
#2 1. Via menu > Voorkeuren > Raspberry pi Configuratie programma > Interfaces
#2    (tab).
#2 2. Bij SSH selecteer Aan.
#2 3. Klik op OK.
#2 4. Herstart de Raspberry Pi.
...
:
#2  1. Via menu > Voorkeuren > Raspberry pi Configuratie programma >
#2     Localizatie (tab).
