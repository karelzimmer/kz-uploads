#############################################################################
# Bestand:  setup-Ubuntu-15.04-desktop-algemeen.sh                          #
# Doel:     Instellingsbestand voor Ubuntu 15.04 desktop algemeen.          #
# Gebruik:  Door script setup, zie './setup.sh --help' (aanbevolen).        #
#           In het terminalvenster met script setup via                     #
#           './setup.sh setup-Ubuntu-15.04-desktop-algemeen.sh'             #
#           (aanbevolen).                                                   #
#           Direct in het terminalvenster via                               #
#           'bash setup-Ubuntu-15.04-desktop-algemeen.sh'.                  #
