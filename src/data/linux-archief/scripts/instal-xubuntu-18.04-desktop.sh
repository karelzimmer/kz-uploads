# ###############################################################################
# Bestand:  instal-xubuntu-18.04-desktop.sh
# Doel:     Installatiebestand voor Xubuntu 18.04 LTS desktop
# Gebruik:  1. In het terminalvenster met script instal (aanbevolen):
#              instal /usr/local/bin/instal-xubuntu-18.04-desktop.sh
#           2. Direct in het terminalvenster:
#              bash /usr/local/bin/instal-xubuntu-18.04-desktop.sh
...
#              instal -s /usr/local/bin/instal-xubuntu-18.04-desktop.sh
...
sudo echo "$(awk -F/tag/v '{print $2}' '/tmp/vdhcoapp.url' | awk '{print $1}')" | sudo tee /tmp/vdhcoapp.latest
...
## ==============================================================
# Voeg pakketbron toe
ssudo add-apt-repository --yes 'ppa:alexlarsson/flatpak'
...
## ===================================================
# [arch=amd64] omdat anders fout 'missende i386-pakketten' op Xubuntu 64-bit
# Voeg pakketbron toe
...
# Installeer pakketten
sudo apt-get install --yes xubuntu-restricted-extras libavcodec-extra libdvdread4 libdvdcss2 vlc winff
...
## ==================================
sudo apt-get install --yes xubuntu-community-wallpapers-*
