#############################################################################
# Bestand:  install-Ubuntu-15.04-desktop-algemeen.sh                        #
# Doel:     Installatiebestand voor Ubuntu 15.04 desktop algemeen.          #
# Gebruik:  Door script install, zie './install.sh --help' (aanbevolen).    #
#           In het terminalvenster met script install via                   #
#           './install.sh install-Ubuntu-15.04-desktop-algemeen.sh'         #
#           (aanbevolen).                                                   #
#           Direct in het terminalvenster via                               #
#           'sudo bash install-Ubuntu-15.04-desktop-algemeen.sh'.           #
...
# ------------------------------------------------------------------------- #
# Versies:  1.0.0   2015-02-21  Eerste versie.                              #
#############################################################################
