#############################################################################
# Bestand:  install-Lubuntu-14.04-desktop-algemeen.sh                       #
# Doel:     Installatiebestand voor Lubuntu 14.04 LTS desktop algemeen.     #
# Gebruik:  Door script install, zie 'install.sh --help' (aanbevolen).      #
#           In het terminalvenster met script install via                   #
#           './install.sh --file=install-Lubuntu-14.04-desktop-algemeen.sh' #
#           (aanbevolen).                                                   #
#           Direct in het terminalvenster via                               #
#           '[sudo] bash install-Lubuntu-14.04-desktop-algemeen.sh'.        #
...
#2         *    ./install.sh --info --file=install-skype.sh                 *
#2         ******************************************************************
