#############################################################################
# Bestand:  setup-Lubuntu-14.10-desktop-algemeen.sh                         #
# Doel:     Algemeen instellingsbestand voor Lubuntu 14.10 desktop.         #
# Gebruik:  In het terminalvenster met script setup via                     #
#           './setup.sh setup-Lubuntu-14.10-desktop-algemeen.sh'            #
#           (aanbevolen).                                                   #
#           Direct in het terminalvenster via                               #
#           'bash setup-Lubuntu-14.10-desktop-algemeen.sh'.                 #
