###############################################################################
# Bestand:  setup-xubuntu-17.10-desktop.sh
# Doel:     Instellingsbestand voor Xubuntu 17.10 desktop.
# Gebruik:  1. In het terminalvenster met script setup (aanbevolen):
#              setup ~/bin/setup-xubuntu-17.10-desktop.sh
#           2. Direct in het terminalvenster:
#              bash ~/bin/setup-xubuntu-17.10-desktop.sh
...
#              setup -s ~/bin/setup-xubuntu-17.10-desktop.sh
...
# Stel in enkelklik om te openen (1/2)
...
# Stel in enkelklik om te openen (2/2)
# Aanpassen via rechtsklikken op bureaublad > Bureaublad-instellingen > Pictogrammen (tab).
