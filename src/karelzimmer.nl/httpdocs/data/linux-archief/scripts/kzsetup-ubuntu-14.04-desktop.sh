...
###############################################################################
# Instellingsbestand voor Ubuntu 14.04 LTS desktop.
#
...
#4
#4 Start Terminalvenster en voer uit:
#4       gsettings set com.canonical.Unity.Launcher favorites "$(gsettings get com.canonical.Unity.Launcher favorites | sed --expression="s|'application://spotify_spotify.desktop', ||g" | sed --expression="s|, 'application://spotify_spotify.desktop'||")"
