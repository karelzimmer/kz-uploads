#############################################################################
# Bestand:  setup-lubuntu-16.04-desktop.sh                                  #
# Doel:     Instellingsbestand voor Lubuntu 16.04 desktop.                  #
# Gebruik:  In het terminalvenster met script setup (aanbevolen):           #
#           setup [~/bin/setup-lubuntu-16.04-desktop.sh]                    #
#           Direct in het terminalvenster:                                  #
#           bash ~/bin/setup-lubuntu-16.04-desktop.sh                       #
...
#           setup -s [~/bin/setup-lubuntu-16.04-desktop.sh]                 #
...
## ------------------------------
## Aanpassen via Hulpmiddelen > Bestandbeheerder PCManFM > Bewerken >
## Voorkeuren.
sed 's/single_click=0/single_click=1/g' $HOME/libfm/libfm.conf
