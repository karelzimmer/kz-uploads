...
###############################################################################
# Instellingsbestand voor Ubuntu 16.04 LTS desktop.
#
...
## App Folder 'KZ-Scripts' toevoegen.
if [[ $(gsettings get org.gnome.desktop.app-folders folder-children) = '@as []' ]] ; then gsettings set org.gnome.desktop.app-folders folder-children "['KZ-Scripts']"; fi
if ! gsettings get org.gnome.desktop.app-folders folder-children | grep --quiet --word-regexp --regexp='KZ-Scripts'; then gsettings set org.gnome.desktop.app-folders folder-children "$(gsettings get org.gnome.desktop.app-folders folder-children | awk -F] '{print $1}'), 'KZ-Scripts']"; fi
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/KZ-Scripts/ name 'Scripts'
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/KZ-Scripts/ translate true
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/KZ-Scripts/ categories "['KZ-Scripts']"
...
gsettings set com.canonical.Unity.Launcher favorites "$(gsettings get com.canonical.Unity.Launcher favorites | sed --expression="s|'application://ubuntu-amazon-default.desktop', ||g" | sed --expression="s|, 'application://ubuntu-amazon-default.desktop'||")"
#3
...
#4    gsettings reset com.canonical.indicator.datetime show-day
#4    gsettings reset com.canonical.indicator.datetime show-week-numbers
...
#4    gsettings reset com.canonical.Unity.Launcher favorites
## Als 1e uitvoeren! ##
...
if ! gsettings get com.canonical.Unity.Launcher favorites | grep --quiet --word-regexp --regexp='bitwarden_bitwarden.desktop'; then gsettings set com.canonical.Unity.Launcher favorites "$(gsettings get com.canonical.Unity.Launcher favorites | awk -F] '{print $1}'), 'application://bitwarden_bitwarden.desktop']"; fi
#3
...
#4       gsettings set com.canonical.Unity.Launcher favorites "$(gsettings get com.canonical.Unity.Launcher favorites | sed --expression="s/'application://bitwarden_bitwarden.desktop', //g" | sed --expression="s/, 'application://bitwarden_bitwarden.desktop'//")"
#4
#4 Voor Firefox
#4 ============
#4 1. Start Firefox webbrowser.
...
if ! gsettings get com.canonical.Unity.Launcher favorites | grep --quiet --word-regexp --regexp='google-chrome.desktop'; then gsettings set com.canonical.Unity.Launcher favorites "['application://google-chrome.desktop', $(gsettings get com.canonical.Unity.Launcher favorites | awk -F[ '{print $2}')"; fi
...
#4       gsettings set com.canonical.Unity.Launcher favorites "$(gsettings get com.canonical.Unity.Launcher favorites | sed --expression="s/'application://google-chrome.desktop', //g" | sed --expression="s/, 'application://google-chrome.desktop'//")"
...
#1 skype
#2 Skype instellen
if ! gsettings get com.canonical.Unity.Launcher favorites | grep --quiet --word-regexp --regexp='skype_skypeforlinux.desktop'; then gsettings set com.canonical.Unity.Launcher favorites "$(gsettings get com.canonical.Unity.Launcher favorites | awk -F] '{print $1}'), 'application://skype_skypeforlinux.desktop']"; fi
#4
#4 Start Terminalvenster en voer uit:
#4    gsettings set com.canonical.Unity.Launcher favorites "$(gsettings get com.canonical.Unity.Launcher favorites | sed --expression="s/'application://skype_skypeforlinux.desktop', //g" | sed --expression="s/, 'application://skype_skypeforlinux.desktop'//")"


#1 spotify
#2 Spotify instellen
if ! gsettings get com.canonical.Unity.Launcher favorites | grep --quiet --word-regexp --regexp='spotify_spotify.desktop'; then gsettings set com.canonical.Unity.Launcher favorites "$(gsettings get com.canonical.Unity.Launcher favorites | awk -F] '{print $1}'), 'application://spotify_spotify.desktop']"; fi
#3
#3 1. Start Spotify.
#3 2. Aanmelden.
...
#4
#4 Start Terminalvenster en voer uit:
#4    gsettings set com.canonical.Unity.Launcher favorites "$(gsettings get com.canonical.Unity.Launcher favorites | sed --expression="s/'application://application://spotify_spotify.desktop', //g" | sed --expression="s/, 'application://spotify_spotify.desktop'//")"


#1 zoom
#2 Zoom instellen
if ! gsettings get com.canonical.Unity.Launcher favorites | grep --quiet --word-regexp --regexp='Zoom.desktop'; then gsettings set com.canonical.Unity.Launcher favorites "$(gsettings get com.canonical.Unity.Launcher favorites | awk -F] '{print $1}'), 'application://Zoom.desktop']"; fi
#4
#4 Start Terminalvenster en voer uit:
#4    gsettings set com.canonical.Unity.Launcher favorites "$(gsettings get com.canonical.Unity.Launcher favorites | sed --expression="s/'application://Zoom.desktop', //g" | sed --expression="s/, 'application://Zoom.desktop'//")"
